...
define('RL_DBUSER', getenv('DB_USER') ?: 'gmoplus_bookinguser');
define('RL_DBPASS', getenv('DB_PASSWORD') ?: 'gmoplus_bookinguser111');
define('RL_DBNAME', getenv('DB_NAME') ?: 'gmoplus_booking');
define('RL_DBPREFIX', getenv('DB_PREFIX') ?: 'fl_');

// system paths
// system paths
define('RL_DIR', '');
define('RL_ROOT', realpath(__DIR__ . '/..') . RL_DS . RL_DIR);
...
define('RL_SETUP', 'JGxpY2Vuc2VfZG9tYWluID0gImJvb2tpbmcuZ21vcGx1cy5jb20iOyRsaWNlbnNlX251bWJlciA9ICJGTDA0STVHUEI5REMiOw==');
/* END CODE */
